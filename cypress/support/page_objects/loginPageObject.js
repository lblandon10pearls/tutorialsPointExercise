...
export class LoginPage{
  ...
  goToSyncUp()
  {
    cy.get('[src="/html/src/iframes.htm"]', { timeout: 180000 }).then($firstIframe => {
      const $secondIframeReference = $firstIframe.contents().find('[src="/html/menu.htm"]', { timeout: 180000 });
      cy.wrap($secondIframeReference).as('secondIframeReference'); 
    
      cy.get('@secondIframeReference', { timeout: 180000 }).then($secondIframe => {
